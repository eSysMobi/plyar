...
public interface LocationFinder {
	...
	/**
	 * A working location provider has been found: check if the found location
	...
	/**
	 * Gets the location that was used in the last download for datasources.
	 * 
	 * @return
	 */
	 ...
	 */
	void setLocationAtLastDownload(Location locationLast);
